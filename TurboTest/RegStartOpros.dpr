program RegStartOpros;

//  программа регистрации программы заглушки StartOpros
//  создаются две ветви:
//  для программы StartOpros:
//      HKEY_CLASSES_ROOT\CLSID\<индивидуальный GUID>\InprocServer32
//  для программы TurboOpros
